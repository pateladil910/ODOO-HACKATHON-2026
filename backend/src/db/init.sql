...
VALUES
(1, 'Registration Card', '/uploads/documents/Registration_VAN-01.pdf', 'application/pdf'),
(1, 'Insurance Policy', '/uploads/documents/Insurance_VAN-01.pdf', 'application/pdf'),
(2, 'Registration Card', '/uploads/documents/Registration_TRK-02.pdf', 'application/pdf'),
(2, 'Insurance Policy', '/uploads/documents/Insurance_TRK-02.pdf', 'application/pdf'),
(3, 'Registration Card', '/uploads/documents/Registration_VAN-03.pdf', 'application/pdf'),
(3, 'Insurance Policy', '/uploads/documents/Insurance_VAN-03.pdf', 'application/pdf'),
(4, 'Registration Card', '/uploads/documents/Registration_TRK-04.pdf', 'application/pdf'),
(4, 'Insurance Policy', '/uploads/documents/Insurance_TRK-04.pdf', 'application/pdf'),
(5, 'Registration Card', '/uploads/documents/Registration_VAN-05.pdf', 'application/pdf'),
(5, 'Insurance Policy', '/uploads/documents/Insurance_VAN-05.pdf', 'application/pdf');
